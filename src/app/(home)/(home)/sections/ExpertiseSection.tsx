...
const ExpertiseSection = () => {
  return (
    <section className="h-[400vh] bg-white relative">
      <div className="flex flex-col md:flex-row justify-around sticky top-[5rem]">
      ...
      <div className="sticky text-black font-semibold text-center pt-[5rem] md:pt-[10rem] top-0 bottom-0 h-[100vh]">
        <h2>About Me</h2>
      </div>

      <div className="absolute h-full top-0 left-0 right-0 flex flex-col justify-start items-center text-xl max-w-[60rem] mx-auto px-[2rem]">
        ...
        <div className="h-[100vh] flex items-center sticky top-0">
          <div className="text-black/80 font-semibold bg-[rgba(var(--primary-green-rgb),0.05)] backdrop-blur p-[.5rem] mt-[35rem] rounded-[2rem] hover:shadow-[0_5px_20px_0px_rgba(0,0,0,0.05)]">
